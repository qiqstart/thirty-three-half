...
export function makeRecordTexture(side: "A" | "B"): THREE.CanvasTexture {
  ...
  g.font = "600 58px 'Cormorant Garamond', Georgia, serif";
  g.fillText("33½", cx, cy - 8);
  g.font = "500 15px Figtree, sans-serif";
  g.fillText("MICROGROOVE", cx, cy + 34);
  g.font = "500 13px Figtree, sans-serif";
  g.fillText(side === "B" ? "SIDE B" : "SIDE A", cx, cy + 54);
  g.beginPath();
