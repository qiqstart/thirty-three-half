...
export function makeRecordTexture(side: "A" | "B"): THREE.CanvasTexture {
  ...
  g.fillText("RECORD KILLER", cx, cy - 36);
  g.font = "600 22px Figtree, sans-serif";
  g.fillText("KILLER RECORD", cx, cy - 14);
  g.font = "600 36px 'Cormorant Garamond', Georgia, serif";
  g.fillText("33½", cx, cy + 16);
  g.font = "500 12px Figtree, sans-serif";
  g.fillText(side === "B" ? "SIDE B" : "SIDE A", cx, cy + 42);
  g.beginPath();
